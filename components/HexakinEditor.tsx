...
import { Clock, Edit, Trash2, Send, Zap } from "lucide-react"; // Added some icons for polish
...
export default function HexakinEditor() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="p-6 border rounded-lg bg-white dark:bg-gray-800/50 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div>
            ...
            <select className="w-full border px-2 py-1.5 rounded-md bg-white dark:bg-gray-700" value={purpose} onChange={(e) => setPurpose(e.target.value)}>
          ...
          <div>
            ...
            <select className="w-full border px-2 py-1.5 rounded-md bg-white dark:bg-gray-700" value={style} onChange={(e) => setStyle(e.target.value)}>
          ...
          <div>
            ...
            <select className="w-full border px-2 py-1.5 rounded-md bg-white dark:bg-gray-700" value={editorType} onChange={(e) => setEditorType(e.target.value)}>
        ...
        <div className="mb-4">
          ...
          <textarea
            className="w-full h-32 border px-3 py-2 rounded-md bg-white dark:bg-gray-700"
        ...
        <div className="mb-4">
          ...
          <div ref={outputRef} className="w-full min-h-[100px] border p-3 bg-gray-50 dark:bg-gray-700/50 rounded-md whitespace-pre-wrap">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <div className="flex flex-col gap-2">
              <select className="border px-2 py-1.5 rounded-md bg-white dark:bg-gray-700" value={selectedRefine} onChange={(e) => setSelectedRefine(e.target.value)}>
                <option value="">Select refinement type...</option>
                {REFINE_OPTIONS.map((opt) => (<option key={opt}>{opt}</option>))}
              </select>
              {selectedRefine === "Custom" && (
                <input type="text" placeholder="Enter custom refinement" className="border px-2 py-1.5 rounded-md w-full bg-white dark:bg-gray-700" value={refinePrompt} onChange={(e) => setRefinePrompt(e.target.value)} />
              )}
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select value={targetTone} onChange={(e) => setTargetTone(e.target.value)} className="mb-2 w-full border px-2 py-1.5 rounded-md bg-white dark:bg-gray-700">
